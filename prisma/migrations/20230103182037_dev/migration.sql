/*
  ...
  - You are about to drop the column `transactions` on the `BTC_Addresses` table. All the data in the column will be lost.
...
CREATE TABLE "new_BTC_Addresses" (
    ...
    "currentBtcPrice" REAL NOT NULL DEFAULT 0,
