...
INSERT INTO "new_Products" ("acc_no", "address", "address2", "buyerId", "cc_num", "city", "country", "createdAt", "cvv2", "databaseId", "dbVersion", "dob", "driver_license", "email", "exp_date", "exp_month", "exp_year", "first_name", "full_name", "id", "ip", "last_name", "misc", "mmn", "old_price", "password", "phone", "price", "sellerId", "skip", "sort_code", "ssn", "state", "status", "type", "updatedAt", "userId", "vbv", "zip") SELECT "acc_no", "address", "address2", "buyerId", "cc_num", "city", "country", "createdAt", "cvv2", "databaseId", "dbVersion", "dob", "driver_license", "email", "exp_date", "exp_month", "exp_year", "first_name", "full_name", "id", "ip", "last_name", "misc", "mmn", "old_price", "password", "phone", "price", "sellerId", "skip", "sort_code", "ssn", "state", "status", "type", "updatedAt", "userId", "vbv", "zip" FROM "Products";
DROP TABLE "Products";
