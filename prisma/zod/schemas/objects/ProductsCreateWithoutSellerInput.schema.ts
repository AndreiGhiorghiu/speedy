...
import { DatabaseCreateNestedOneWithoutProductsInputObjectSchema } from './DatabaseCreateNestedOneWithoutProductsInput.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.ProductsCreateWithoutSellerInput> = z
  .object({
    ...
    User: z
      ...
      .optional(),
    database: z.lazy(
      () => DatabaseCreateNestedOneWithoutProductsInputObjectSchema,
    ),
...
export const ProductsCreateWithoutSellerInputObjectSchema = Schema;
