...
const Schema: z.ZodType<Prisma.SessionsUpdateManyWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => SessionsUpsertWithWhereUniqueWithoutUserInputObjectSchema),
        z
          .lazy(() => SessionsUpsertWithWhereUniqueWithoutUserInputObjectSchema)
          .array(),
      ])
      .optional(),
    set: z
    ...
    update: z
      .union([
        z.lazy(() => SessionsUpdateWithWhereUniqueWithoutUserInputObjectSchema),
        z
          .lazy(() => SessionsUpdateWithWhereUniqueWithoutUserInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const SessionsUpdateManyWithoutUserNestedInputObjectSchema = Schema;
