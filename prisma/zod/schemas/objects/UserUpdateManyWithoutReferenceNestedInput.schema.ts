...
const Schema: z.ZodType<Prisma.UserUpdateManyWithoutReferenceNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => UserUpdateManyWithWhereWithoutReferenceInputObjectSchema),
        z
          .lazy(() => UserUpdateManyWithWhereWithoutReferenceInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const UserUpdateManyWithoutReferenceNestedInputObjectSchema = Schema;
