...
const Schema: z.ZodType<Prisma.ProductsUncheckedUpdateManyWithoutBuyerNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => ProductsUpdateManyWithWhereWithoutBuyerInputObjectSchema,
          ),
          z
            .lazy(
              () => ProductsUpdateManyWithWhereWithoutBuyerInputObjectSchema,
...
export const ProductsUncheckedUpdateManyWithoutBuyerNestedInputObjectSchema =
  Schema;
