...
const Schema: z.ZodType<Prisma.ProductsUncheckedCreateWithoutDatabaseInput> = z
  .object({
...
export const ProductsUncheckedCreateWithoutDatabaseInputObjectSchema = Schema;
