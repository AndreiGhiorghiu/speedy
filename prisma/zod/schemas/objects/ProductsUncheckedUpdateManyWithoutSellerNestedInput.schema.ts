...
const Schema: z.ZodType<Prisma.ProductsUncheckedUpdateManyWithoutSellerNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => ProductsUpdateManyWithWhereWithoutSellerInputObjectSchema,
          ),
          z
            .lazy(
              () => ProductsUpdateManyWithWhereWithoutSellerInputObjectSchema,
...
export const ProductsUncheckedUpdateManyWithoutSellerNestedInputObjectSchema =
  Schema;
