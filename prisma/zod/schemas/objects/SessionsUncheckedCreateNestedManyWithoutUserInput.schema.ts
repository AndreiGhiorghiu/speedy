...
const Schema: z.ZodType<Prisma.SessionsUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const SessionsUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
