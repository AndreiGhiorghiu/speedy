...
const Schema: z.ZodType<Prisma.TicketsUncheckedUpdateManyWithoutReporterNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const TicketsUncheckedUpdateManyWithoutReporterNestedInputObjectSchema =
  Schema;
