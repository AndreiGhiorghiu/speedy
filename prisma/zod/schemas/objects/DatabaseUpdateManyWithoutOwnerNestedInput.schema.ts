...
const Schema: z.ZodType<Prisma.DatabaseUpdateManyWithoutOwnerNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => DatabaseUpdateManyWithWhereWithoutOwnerInputObjectSchema),
        z
          .lazy(() => DatabaseUpdateManyWithWhereWithoutOwnerInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const DatabaseUpdateManyWithoutOwnerNestedInputObjectSchema = Schema;
