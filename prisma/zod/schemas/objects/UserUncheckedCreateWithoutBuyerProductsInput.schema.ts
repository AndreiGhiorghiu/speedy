...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutBuyerProductsInput> = z
  .object({
...
export const UserUncheckedCreateWithoutBuyerProductsInputObjectSchema = Schema;
