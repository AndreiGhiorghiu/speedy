...
import { UserUpdateOneRequiredWithoutSellerProductsNestedInputObjectSchema } from './UserUpdateOneRequiredWithoutSellerProductsNestedInput.schema';
...
const Schema: z.ZodType<Prisma.ProductsUpdateWithoutDatabaseInput> = z
  .object({
    id: z
      .union([
        z.string(),
    ...
    seller: z
      .lazy(
        () => UserUpdateOneRequiredWithoutSellerProductsNestedInputObjectSchema,
      )
      .optional(),
    buyer: z
...
export const ProductsUpdateWithoutDatabaseInputObjectSchema = Schema;
