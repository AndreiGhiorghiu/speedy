...
const Schema: z.ZodType<Prisma.TicketsUpdateManyWithoutParentNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => TicketsUpdateManyWithWhereWithoutParentInputObjectSchema),
        z
          .lazy(() => TicketsUpdateManyWithWhereWithoutParentInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const TicketsUpdateManyWithoutParentNestedInputObjectSchema = Schema;
