...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutSellerProductsInput> =
  z
    .object({
      id: z
        .union([
      ...
      Sessions: z
        .lazy(
          () => SessionsUncheckedUpdateManyWithoutUserNestedInputObjectSchema,
        )
        .optional(),
      BuyerProducts: z
        .lazy(
      ...
      Products: z
        .lazy(
          () => ProductsUncheckedUpdateManyWithoutUserNestedInputObjectSchema,
        )
        .optional(),
      Database: z
        .lazy(
...
export const UserUncheckedUpdateWithoutSellerProductsInputObjectSchema = Schema;
