...
const Schema: z.ZodType<Prisma.InvoiceUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => InvoiceUpsertWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => InvoiceUpsertWithWhereUniqueWithoutUserInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => InvoiceUpdateWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => InvoiceUpdateWithWhereUniqueWithoutUserInputObjectSchema,
...
export const InvoiceUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
