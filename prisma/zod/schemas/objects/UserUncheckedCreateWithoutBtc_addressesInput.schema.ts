...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutBtc_addressesInput> = z
  .object({
...
export const UserUncheckedCreateWithoutBtc_addressesInputObjectSchema = Schema;
