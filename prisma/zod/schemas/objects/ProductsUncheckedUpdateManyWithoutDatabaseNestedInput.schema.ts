...
const Schema: z.ZodType<Prisma.ProductsUncheckedUpdateManyWithoutDatabaseNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductsUncheckedUpdateManyWithoutDatabaseNestedInputObjectSchema =
  Schema;
