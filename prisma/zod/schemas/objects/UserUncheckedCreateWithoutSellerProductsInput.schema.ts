...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutSellerProductsInput> =
  z
    .object({
      ...
      Sessions: z
        .lazy(
          () => SessionsUncheckedCreateNestedManyWithoutUserInputObjectSchema,
        )
        .optional(),
      BuyerProducts: z
        .lazy(
      ...
      Products: z
        .lazy(
          () => ProductsUncheckedCreateNestedManyWithoutUserInputObjectSchema,
        )
        .optional(),
      Database: z
        .lazy(
...
export const UserUncheckedCreateWithoutSellerProductsInputObjectSchema = Schema;
