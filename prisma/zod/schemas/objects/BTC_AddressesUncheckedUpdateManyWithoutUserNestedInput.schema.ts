...
const Schema: z.ZodType<Prisma.BTC_AddressesUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BTC_AddressesUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
