...
const Schema: z.ZodType<Prisma.TicketsUncheckedCreateNestedManyWithoutParentInput> =
  z
    .object({
      create: z
        .union([
...
export const TicketsUncheckedCreateNestedManyWithoutParentInputObjectSchema =
  Schema;
