...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutBtc_addressesInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const UserUncheckedUpdateWithoutBtc_addressesInputObjectSchema = Schema;
