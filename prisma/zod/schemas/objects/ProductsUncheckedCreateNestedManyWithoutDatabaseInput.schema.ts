...
const Schema: z.ZodType<Prisma.ProductsUncheckedCreateNestedManyWithoutDatabaseInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductsUncheckedCreateNestedManyWithoutDatabaseInputObjectSchema =
  Schema;
