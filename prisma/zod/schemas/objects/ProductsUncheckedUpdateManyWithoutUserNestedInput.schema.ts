...
const Schema: z.ZodType<Prisma.ProductsUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => ProductsUpsertWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => ProductsUpsertWithWhereUniqueWithoutUserInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => ProductsUpdateWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => ProductsUpdateWithWhereUniqueWithoutUserInputObjectSchema,
...
export const ProductsUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
