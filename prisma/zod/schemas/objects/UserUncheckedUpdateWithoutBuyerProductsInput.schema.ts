...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutBuyerProductsInput> = z
  .object({
    id: z
      .union([
        z.string(),
...
export const UserUncheckedUpdateWithoutBuyerProductsInputObjectSchema = Schema;
