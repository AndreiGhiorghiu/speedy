...
const Schema: z.ZodType<Prisma.UserUncheckedCreateNestedManyWithoutReferenceInput> =
  z
    .object({
      create: z
        .union([
...
export const UserUncheckedCreateNestedManyWithoutReferenceInputObjectSchema =
  Schema;
