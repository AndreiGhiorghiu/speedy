...
const Schema: z.ZodType<Prisma.ProductsUncheckedCreateNestedManyWithoutSellerInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductsUncheckedCreateNestedManyWithoutSellerInputObjectSchema =
  Schema;
