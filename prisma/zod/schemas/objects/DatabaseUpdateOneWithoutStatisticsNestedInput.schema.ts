...
const Schema: z.ZodType<Prisma.DatabaseUpdateOneWithoutStatisticsNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const DatabaseUpdateOneWithoutStatisticsNestedInputObjectSchema = Schema;
