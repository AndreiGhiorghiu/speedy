...
const Schema: z.ZodType<Prisma.DatabaseCreateNestedOneWithoutStatisticsInput> =
  z
    .object({
      create: z
        .union([
...
export const DatabaseCreateNestedOneWithoutStatisticsInputObjectSchema = Schema;
