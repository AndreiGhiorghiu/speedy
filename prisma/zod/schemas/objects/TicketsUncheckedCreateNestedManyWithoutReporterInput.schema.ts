...
const Schema: z.ZodType<Prisma.TicketsUncheckedCreateNestedManyWithoutReporterInput> =
  z
    .object({
      create: z
        .union([
...
export const TicketsUncheckedCreateNestedManyWithoutReporterInputObjectSchema =
  Schema;
