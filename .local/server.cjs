...
var sessions_default = {
  ...
  getUserBySession: async function(session) {
    ...
    if ((_a = dbSession == null ? void 0 : dbSession.user) == null ? void 0 : _a.role) {
      dbSession.user.role = JSON.parse(dbSession == null ? void 0 : dbSession.user.role);
    }
    return dbSession == null ? void 0 : dbSession.user;
  },
...
fastify.addHook("onRoute", (route2) => {
  route2.preHandler = async (request, reply, done) => {
    var _a;
    const isGuest = (_a = route2 == null ? void 0 : route2.accept) == null ? void 0 : _a.includes("guest");
    if (!isGuest) {
...
var auth_default = {
  add: async function(data) {
    ...
    data.role = JSON.stringify((data == null ? void 0 : data.role) || ["guest"]);
...
route({
  ...
  handler: async function(req, rep) {
    ...
    const from = ((cookie == null ? void 0 : cookie.indexOf("=")) || 0) + 1;
    const to = (cookie == null ? void 0 : cookie.indexOf(";")) || 0;
    const sessionId = cookie == null ? void 0 : cookie.substring(from, to);
...
route({
  ...
  handler: async function(req, rep) {
    try {
      ...
      if (!(user == null ? void 0 : user.referenceId)) {
