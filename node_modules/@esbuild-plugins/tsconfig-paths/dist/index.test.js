...
test('works', function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, unlink, base, _b, ENTRY, UTILS, called, resolved, tsconfig, res, expected;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _a = _c.sent(), unlink = _a.unlink, base = _a.base, _b = __read(_a.paths, 2), ENTRY = _b[0], UTILS = _b[1];
                called = 0;
                resolved = [];
                tsconfig = {
                    baseUrl: '.',
            ...
            case 2:
                ...
                expected = ['utils.ts'];
                expect(resolved.map(function (x) { return slash_1.default(path_1.default.relative(base, x)); })).toEqual(expected);
                unlink();
                return [2 /*return*/];
        }
    });
